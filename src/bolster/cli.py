...
def dfc():
    ...
    including Child Maintenance Service caseload and enforcement figures and
...
def list_sources():
    ...
    click.echo("  translink route      Next N direct journeys between two stops")
    click.echo("                       Direct services only — no connections suggested")
    ...
    click.echo("  nisra civil-partnerships   Monthly civil partnership registrations")
    click.echo("  nisra drug-related-deaths  Drug-related and drug misuse deaths")
    ...
    click.echo("  nisra claimant-count       Claimant count (Universal Credit + JSA)")
    click.echo("  nisra quarterly-employment-survey  Employee jobs by sector (QES)")
    click.echo("  nisra business-register    NI Business Register (IDBR), annual")
    click.echo("  nisra neet                 Young people not in education, employment or training")
    ...
    click.echo("  nisra diagnostic-waiting-times Diagnostic test waiting times")
    click.echo("  nisra disease-prevalence   Raw disease prevalence by GP practice/LCG")
    click.echo("  nisra hsc-workforce        HSC workforce headcount and vacancies")
    click.echo("  nisra hsc-recruitment      HSC active recruitment statistics")
    ...
    click.echo("  nisra housing-stock        NI housing stock by tenure and district")
    click.echo("  nisra deprivation          NI Multiple Deprivation Measure 2017 (NIMDM)")
    click.echo("  nisra school-leavers       School Leavers Survey — attainment and destinations")
    click.echo("  nisra teacher-workforce    Teacher workforce statistics")
    click.echo("  nisra public-confidence    Public confidence in official statistics")
    ...
    click.echo("  psni stop-search           Stop and search statistics (2017/18 onwards)")
    click.echo("  psni pace                  PACE (Police and Criminal Evidence Order) statistics")
    click.echo("  psni motoring-offences     Motoring offence detections and outcomes")
    click.echo("  psni ombudsman             Police Ombudsman complaint statistics")

    click.echo("\nJUSTICE DATA MODULES (bolster justice <command>)")
    click.echo("  justice mortgages          NICTS mortgage actions for possession (quarterly)")
    click.echo("  justice nicts-quarterly    NICTS provisional court business figures")
    click.echo("  justice pbni-caseload      Probation Board NI caseload statistics")
    click.echo("  justice first-time-entrants  First time entrants to the criminal justice system")
    click.echo("  justice prosecutions-convictions  Court prosecutions, convictions and out-of-court disposals")
    click.echo("  justice pps-statistical-bulletin  Public Prosecution Service statistical bulletin")
    ...
    click.echo("  dfc frs                    Family Resources Survey for Northern Ireland (DfC)")
    click.echo("  dfi school-travel          YPBAS: travel to and from school (DfI)")
    click.echo("  daera greenhouse-gas       NI Greenhouse Gas Inventory statistics")
    click.echo("  daera waste                NI local authority collected municipal waste")
