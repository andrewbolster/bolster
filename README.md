...
| Economy (DfE) | [`electricity_renewables`](https://bolster.readthedocs.io/en/latest/data_sources.html#electricity-consumption-and-renewable-generation), [`higher_education_enrolments`](https://bolster.readthedocs.io/en/latest/data_sources.html#higher-education-enrolments) | Electricity consumption and renewable generation progress; NI/UK HEI enrolments (HESA) |
